<?php
/**
 * The Manage Polls screen.
 *
 * Three views share it: the list of polls, the edit form, and the log of one
 * poll. The list is a WP_List_Table; the other two are ordinary form-table
 * forms that post back here.
 *
 * @package WP-Polls
 */
 ...
 * Manage screen.
 */
class WP_Polls_Screen_Manage {

	/**
	 * Render whichever of the three views the request asked for.
	 *
	 * @return void
	 */
	public static function render() {
		...
		switch ( $poll_mode ) {
			// Poll Logging.
			case 'logs':
				WP_Polls_Screen_Logs::render( $poll_id, $text );
				break;
			// Edit A Poll.
			case 'edit':
