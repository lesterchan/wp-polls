 ...
 * WP_Polls_Settings as a section and a field, so all this file does is draw the
 * tabs, open the form, hand it to do_settings_sections() and close it. Saving
 * is the Settings API's: the form posts to options.php, which checks the nonce
 * and hands the input to WP_Polls_Settings::sanitize().
 *
 * @package WP-Polls
 */
